...
DECLARE
  ...
  p_redo_count  PLS_INTEGER   := 4;                    -- redo groups per instance (default 6)
  p_redo_size   VARCHAR2(32)  := '1024M';                 -- redo size (default 4G)
  p_redo_path   VARCHAR2(512) := '/data/yashan/yasdb_data/db-1-1/dbfiles';           -- target path; empty = from V$LOGFILE
