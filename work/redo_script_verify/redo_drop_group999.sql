...
DECLARE
  p_target      VARCHAR2(512) := TRIM('99999');
...
BEGIN
  IF p_target IS NULL OR LENGTH(p_target) = 0 OR p_target = '99999' THEN
    RAISE_APPLICATION_ERROR(-20001, 'Missing 99999: pass redo group id (digits) or file/directory path');
  END IF;
