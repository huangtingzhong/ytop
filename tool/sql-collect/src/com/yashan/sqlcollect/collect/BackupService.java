...
public class BackupService {
    ...
    public Result run(JdbcSession session) throws SQLException {
        ...
        log.logInfo("backup owner=" + owner + " (login-user schema)");
        ...
        log.logInfo("backup INSERT " + HtzTables.GV_SQL + " rows=" + ins);
        ...
        log.logInfo("backup INSERT " + HtzTables.GV_SQLSTATS + " rows=" + ins);
        ...
        log.logInfo("backup INSERT " + HtzTables.GV_BIND + " rows=" + ins);

        c.commit();
        r.newSqlIds = fetchNewSqlIds(c, t0, tSql, tStat, tBind);
        log.logInfo("backup done BACKUP_NEW_N=" + r.newSqlIds.size());
