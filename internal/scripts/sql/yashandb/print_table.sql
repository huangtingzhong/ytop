-- File Name: print_table.sql
-- Purpose: YashanDB Print query rows in vertical G style
...
-- maps $ident to #ident in your &query_sql input; this script restores # via CHR(36).
...
DECLARE
  p_query     VARCHAR2(32767) := '&query_sql';
  c_id        INTEGER;
  col_cnt     INTEGER;
