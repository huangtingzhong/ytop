-- File Name: awr_segment_physical_reads.sql
-- Purpose: Oracle AWR Segment Physical Reads
...
col physical_reads for 9999999999999999 heading 'Physical Reads'
...
SELECT owner,
  ...
  FROM (  SELECT n.owner,
            ...
            FROM dba_hist_seg_stat_obj n,
                 ...
                 (SELECT SUM (physical_reads_delta) phyr
                    FROM dba_hist_seg_stat
                   WHERE     :bid < snap_id
