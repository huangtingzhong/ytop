-- File Name: we.sql
-- Purpose: Oracle Session wait and SQL overview
-- Created: 20150905  by  huangtingzhong

SET ECHO OFF
SET PAGESIZE 2000  LINESIZE 250 VERIFY OFF HEADING ON
COL event       FOR a18   HEADING "EVENT"
COL program     FOR a23   HEADING "PROGRAM"
COL os_sess     FOR a25   HEADING "SESS_SERIAL|OSPID"
COL u_s         FOR a22   HEADING "USERNAME|LAST_CALL|SEQ#"
...
&_VERSION_12 and b.con_id=c.con_id and b.con_id=s.con_id
   ...
   and b.program not like 'extract@%'
   AND b.program not like 'oracle@% (OFSD)'
