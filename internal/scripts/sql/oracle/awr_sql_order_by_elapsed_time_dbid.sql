-- File Name: awr_sql_order_by_elapsed_time_dbid.sql
-- Purpose: Oracle AWR SQL Order By Elapsed Time Dbid
...
/* Formatted on 2013/2/25 17:10:46 (QP5 v5.215.12089.38647) */
WITH sqt
     AS (SELECT elap,
                cput,
                exec,
