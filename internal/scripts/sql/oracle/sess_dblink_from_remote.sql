-- File Name: sess_dblink_from_remote.sql
-- Purpose: Oracle session Dblink From Remote
...
&_LONG_MODE       row_wait_row# row_wait
 ...
 WHERE b.paddr = c.addr
   ...
   and b.module = b.program
   and b.program = 'oracle@' || b.machine || ' (TNS V1-V3)'
&_VERSION_12 and b.con_id=c.con_id and b.con_id=s.con_id
 ...
 inst_id, sql_id
/
select inst_id,machine,count(*) from gv$session b where b.module = b.program
   and b.program = 'oracle@' || b.machine || ' (TNS V1-V3)'
