-- File Name: awr_parameter_change.sql
-- Purpose: Oracle AWR Parameter Change
 ...
 *********************************************************************/
set echo off feedback off timing off pagesize 100 linesize 200 trimout on trimspool on
set verify off
...
col old_value format a25 heading "Old Value"
col new_value format a25 heading "New Value"
...
select  to_char(s.begin_interval_time, 'YYYY-MM-DD HH24:MI:SS') snap_time,
        p.instance_number,
        p.snap_id,
        p.name,
        p.old_value,
